...
No installation script are available yet.

Copy the file conf.yml.example in conf.yml and edit it as you want.
    cp conf.yml.example conf.yml

To launch the server just use:
    python3 server.py
...
Or pass options to server.py call. Eg :
    python3 server.py --name MyStepmaniaServer --motd "Welcome on my new server!"
